...
import com.example.nearbylocations.data.network.retrofit.RetrofitNearbyLocationInterface
...
class RetrofitModule {
    ...
    @Singleton
    @Provides
    fun getMainInterface(retrofit: Retrofit): RetrofitNearbyLocationInterface =
        retrofit.create(RetrofitNearbyLocationInterface::class.java)
}
